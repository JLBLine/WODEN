...
CC_INCLUDES = -I/usr/local/cuda/include  #cc comp includes
...
CC_LINKLIBS = -L/usr/local/cuda/lib64 -lm -lcuda -lcudart -lcufft   ##Linking libs

##CC sources and objs
CC_SRCS := woden.c read_and_write.c shapelet_basis.c telescope_XYZ.c
CC_OBJS := $(CC_SRCS:%.c=%.o)
