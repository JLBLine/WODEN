...
double expec_X_noprec[] = {53.00956, 93.45293 , 173.87949, 106.47388,
                    258.35040, 270.51578, 31.45595, 242.61703};

double expec_Y_noprec[] = {84.00000, 12.00000, 86.00000, 780.00000,
                    813.00000, 899.00000, 460.00000, 810.00000};

double expec_Z_noprec[] = {98.70657, 179.10765, 334.54434, 200.54254,
                    498.02115, 535.55786, 62.53418, 464.51801};

// Some expected X,Y,Z values when calculating from e,n,h in
// example_array_layout.txt, with precession
double expec_X_prec[] = {53.16233, 93.72652, 174.39215, 106.80007,
                  259.13132, 271.35620, 31.56328, 243.34676};

double expec_Y_prec[] = {83.99356, 11.98839, 85.97833, 779.98694,
                  812.96777, 898.96552, 459.99597, 809.96991};

double expec_Z_prec[] = {98.62984, 178.96541, 334.28296, 200.41980,
                  497.66794, 535.19043, 62.50969, 464.18869};


// Expected baseline lengths when using expec_X_noprec, expec_Y_noprec,
// expec_Z_noprec
double expec_X_diffs_noprec[] = { -40.44337, -120.86994, -53.46433, -205.34085,
...
double expec_Y_diffs_noprec[] = { 72.00000, -2.00000, -696.00000, -729.00000,
...
double expec_Z_diffs_noprec[] = { -80.40108, -235.83777, -101.83598, -399.31458,
...
// expec_Z_prec
double expec_X_diffs_prec[] = { -40.56419, -121.22983, -53.63774, -205.96898,
...
double expec_Y_diffs_prec[] = { 72.00517, -1.98477, -695.99341, -728.97424,
...
double expec_Z_diffs_prec[] = { -80.33556, -235.65311, -101.78996, -399.03809,
