...
#define LOW_FREQ 150e+6
#define FREQ_INC 100e+6
#define TIME_RES 3*3600.0
#define MJD_HBA 4929192878.00834
...
void test_run_hba_telescope_reordered(void) {
...
int main(void)
{
    ...
    RUN_TEST(test_run_hba_telescope_reordered);
