...
#define NUM_COORDS 21
#define NUM_DIRS NUM_COORDS*NUM_COORDS
#define NUM_TIMES 2
#define NUM_FREQS 2
#define NUM_STATIONS 2
#define D2R (M_PI/180.0)
#define RA0_OSKAR 0.0*D2R
#define DEC0_OSKAR -30.0*D2R
#define LOW_FREQ 100e+6
#define FREQ_INC 100e+6
#define TIME_RES 3*3600.0
#define MJD_HBA 5228309581.0

void do_run_oskar_beam(const char *ms_path, bool apply_beam_norms,
  ...
  int station_idxs[NUM_STATIONS] = {1, 9};

  eb_status = load_and_run_oskar_beam(ms_path, element_response_model,
                          NUM_STATIONS, station_idxs,
                          NUM_DIRS, RA0_OSKAR, DEC0_OSKAR, ras, decs,
...
void test_run_oskar_telescope_rotate(void) {

  const char ms_path[] = "../../../../test_installation/everybeam/create_OSKAR-SKA_ms/OSKAR-SKA-layout.ms";
  ...
  do_run_oskar_beam(ms_path, apply_beam_norms,
...
void test_run_oskar_telescope_rotate_normed(void) {
...
void test_run_oskar_telescope_reordered(void) {
...
int main(void)
{
    ...
    RUN_TEST(test_run_oskar_telescope_rotate);
    RUN_TEST(test_run_oskar_telescope_rotate_normed);
    RUN_TEST(test_run_oskar_telescope_reordered);
