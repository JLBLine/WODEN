...
void test_calculate_visibilities_UVBeam(int n_points, int n_gauss, int n_shapes,
  ...
  //Check everything works when using a unique beam for each station
...
void test_calculate_visibilities_UVBeam_OneSource_SinglePoint(int do_gpu,int beamtype) {
  ...
  int n_shapes = 0;
  int num_sources = 1;
  test_calculate_visibilities_UVBeam(n_points, n_gauss, n_shapes,
