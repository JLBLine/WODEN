...
int main(void)
{
    UNITY_BEGIN();
    // //Test with a single SOURCE, single COMPONENT
    RUN_TEST(test_calculate_visibilities_EveryBeamMWA_OneSource_SinglePoint_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamMWA_OneSource_SingleGauss_cpu);
    ...
    RUN_TEST(test_calculate_visibilities_EveryBeamMWA_ThreeSource_FiveAll_cpu);
