...
int main(void)
{
    UNITY_BEGIN();
    // //Test with a single SOURCE, single COMPONENT
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_OneSource_SinglePoint_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_OneSource_SingleGauss_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_OneSource_SingleShape_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_OneSource_SingleAll_cpu);

    //Test with three SOURCEs, single COPMONENT
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_SinglePoint_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_SingleGauss_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_SingleShape_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_SingleAll_cpu);

    //Test with three SOURCEs, five COPMONENTs
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_FivePoint_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_FiveGauss_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_FiveShape_cpu);
    RUN_TEST(test_calculate_visibilities_EveryBeamOSKAR_ThreeSource_FiveAll_cpu);
