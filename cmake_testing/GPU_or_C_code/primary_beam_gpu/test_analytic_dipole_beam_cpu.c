...
*/
void test_analytic_dipole_beam_GivesCorrectValues_cpu(void) {
  test_analytic_dipole_beam_GivesCorrectValues(0);
}
...
{
    UNITY_BEGIN();
    RUN_TEST(test_analytic_dipole_beam_GivesCorrectValues_cpu);
    return UNITY_END();
}
