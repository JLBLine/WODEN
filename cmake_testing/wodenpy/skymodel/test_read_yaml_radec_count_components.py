...
class Test(unittest.TestCase):
    ...
    # def test_read_full_catalogue(self):
        
    #     skymodel = '/home/jline/software/WODEN_dev/examples/MWA_EoR0/srclist_pumav3_EoR0LoBESv2_fixedEoR1pietro+ForA_phase1+2_edit.yaml'
    #     comp_counter = read_yaml_skymodel.read_yaml_radec_count_components(skymodel)
    ...
    def run_and_check_tots_read_yaml_radec_count_components(self,
                                    skymodel : str,
                                    expec_nums : Expected_Total_Nums,
    ...
    def test_SinglePointPower(self):
        ...
        skymodel = '{:s}/yaml_models/srclist_singlepoint_power.yaml'.format(code_dir)
        ...
        comp_counter = self.run_and_check_tots_read_yaml_radec_count_components(skymodel,
    ...
    def test_SingleGaussianPower(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singlegauss_power.yaml'.format(code_dir)
    ...
    def test_SingleShapeletPower(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singleshape_power.yaml'.format(code_dir)
    ...
    def test_ThreeSourcesPower(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_threesources_power.yaml'.format(code_dir)
    ...
    def test_ThreeComponentsPower(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_threecomponents_power.yaml'.format(code_dir)
    ...
    def test_SinglePointCurved(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singlepoint_curve.yaml'.format(code_dir)
    ...
    def test_SingleGaussianCurved(self):
        """srclist that contains a single gaussian with a power law"""
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singlegauss_curve.yaml'.format(code_dir)
    ...
    def test_SingleShapeletCurved(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singleshape_curve.yaml'.format(code_dir)
    ...
    def test_ThreeSourcesCurved(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_threesources_curve.yaml'.format(code_dir)
    ...
    def test_ThreeComponentsCurved(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_threecomponents_curve.yaml'.format(code_dir)
    ...
    def test_SinglePointList(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singlepoint_list.yaml'.format(code_dir)
    ...
    def test_SingleGaussianList(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singlegauss_list.yaml'.format(code_dir)
    ...
    def test_SingleShapeletList(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_singleshape_list.yaml'.format(code_dir)
    ...
    def test_ThreeSourcesList(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_threesources_list.yaml'.format(code_dir)
    ...
    def test_ThreeComponentsList(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_threecomponents_list.yaml'.format(code_dir)
    ...
    def test_MultiSourceComponents(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_mulitple_source-components.yaml'.format(code_dir)
    ...
    def test_SinglePointEmpty(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_empty_line.yaml'.format(code_dir)
    ...
    def test_SinglePointComments(self):
        ...
        ##sky model used for testing
        skymodel = '{:s}/yaml_models/srclist_comment.yaml'.format(code_dir)
