...
void read_source_catalogue(source_catalogue_t *cropped_sky_models){
  ...
  fprintf(output_text, "cropped_sky_models->sources[1].gauss_components.ras[0] %.16f\n", cropped_sky_models->sources[1].gauss_components.ras[0]);
  fprintf(output_text, "cropped_sky_models->sources[1].gauss_components.ras[1] %.16f\n", cropped_sky_models->sources[1].gauss_components.ras[1]);
  fprintf(output_text, "cropped_sky_models->sources[1].gauss_components.ras[2] %.16f\n", cropped_sky_models->sources[1].gauss_components.ras[2]);
