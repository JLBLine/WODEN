...
void test_calculate_visibilities_GaussBeam_ThreeSource_FivePoint(void) {
  int n_points = 5;
  int n_gauss = 0;
  int n_shapes = 0;
  int num_sources = 3;
...
void test_calculate_visibilities_GaussBeam_ThreeSource_FiveGauss(void) {
  int n_points = 0;
  int n_gauss = 5;
  int n_shapes = 0;
  int num_sources = 3;
...
void test_calculate_visibilities_GaussBeam_ThreeSource_FiveShape(void) {
  int n_points = 0;
  int n_gauss = 0;
  int n_shapes = 5;
  int num_sources = 3;
...
void test_calculate_visibilities_GaussBeam_ThreeSource_FiveAll(void) {
  int n_points = 5;
  int n_gauss = 5;
  int n_shapes = 5;
  int num_sources = 3;
...
int main(void)
{
    ...
    //Test with three SOURCEs, three COPMONENTs
    RUN_TEST(test_calculate_visibilities_GaussBeam_ThreeSource_FivePoint);
    RUN_TEST(test_calculate_visibilities_GaussBeam_ThreeSource_FiveGauss);
    RUN_TEST(test_calculate_visibilities_GaussBeam_ThreeSource_FiveShape);
    RUN_TEST(test_calculate_visibilities_GaussBeam_ThreeSource_FiveAll);
