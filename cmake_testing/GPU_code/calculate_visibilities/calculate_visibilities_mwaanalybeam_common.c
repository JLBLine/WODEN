...
void test_calculate_visibilities_MWAAnalyBeam_OneSource_SinglePoint(int do_gpu) {
  int n_points = 1;
  int n_gauss = 0;
  int n_shapes = 0;
  int num_sources = 1;
...
void test_calculate_visibilities_MWAAnalyBeam_OneSource_SingleGauss(int do_gpu) {
  int n_points = 0;
  int n_gauss = 1;
  int n_shapes = 0;
  int num_sources = 1;
...
void test_calculate_visibilities_MWAAnalyBeam_OneSource_SingleShape(int do_gpu) {
  int n_points = 0;
  int n_gauss = 0;
  int n_shapes = 1;
  int num_sources = 1;
...
void test_calculate_visibilities_MWAAnalyBeam_OneSource_SingleAll(int do_gpu) {
  int n_points = 1;
  int n_gauss = 1;
  int n_shapes = 1;
  int num_sources = 1;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_SinglePoint(int do_gpu) {
  int n_points = 1;
  int n_gauss = 0;
  int n_shapes = 0;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_SingleGauss(int do_gpu) {
  int n_points = 0;
  int n_gauss = 1;
  int n_shapes = 0;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_SingleShape(int do_gpu) {
  int n_points = 0;
  int n_gauss = 0;
  int n_shapes = 1;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_SingleAll(int do_gpu) {
  int n_points = 1;
  int n_gauss = 1;
  int n_shapes = 1;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_FivePoint(int do_gpu) {
  int n_points = 5;
  int n_gauss = 0;
  int n_shapes = 0;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_FiveGauss(int do_gpu) {
  int n_points = 0;
  int n_gauss = 5;
  int n_shapes = 0;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_FiveShape(int do_gpu) {
  int n_points = 0;
  int n_gauss = 0;
  int n_shapes = 5;
  int num_sources = 3;
...
void test_calculate_visibilities_MWAAnalyBeam_ThreeSource_FiveAll(int do_gpu) {
  int n_points = 5;
  int n_gauss = 5;
  int n_shapes = 5;
  int num_sources = 3;
