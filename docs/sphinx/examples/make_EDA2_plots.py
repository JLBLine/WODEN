...
ax1 = aplpy.FITSFigure('../../../examples/EDA2_haslam/images/EDA2_haslam-image.fits',
                        subplot=[0.01,plot_bottom,plot_width, plot_height],figure=fig)

do_plot(ax1,'EDA2 all sky image', -300, 1000, radius=0.5, colour_bar_label=True)

fig.savefig('EDA2_all_sky_image.png',bbox_inches='tight', dpi=100)
plt.close()
