...
ax1 = aplpy.FITSFigure('../../../test_installation/different_beam_models/images/multi-comp_grid_MWA_FEE-image.fits',
                        subplot=[0.01,plot_bottom,plot_width, plot_height],figure=fig)
ax2 = aplpy.FITSFigure('../../../test_installation/different_beam_models/images/multi-comp_grid_MWA_FEE_interp-image.fits',
                        subplot=[plot_width + edge_pad,plot_bottom,plot_width, plot_height],figure=fig)
ax3 = aplpy.FITSFigure('../../../test_installation/different_beam_models/images/multi-comp_grid_MWA_analy-image.fits',
                        subplot=[(plot_width + edge_pad)*2,plot_bottom,plot_width, plot_height],figure=fig)

do_plot(ax1,'MWA FEE (coarse)', 0.0, 0.7)
do_plot(ax2,'MWA FEE (interpolate)',0.0, 0.7,hide_dec_labels=True)
do_plot(ax3,'MWA Analy',0.0, 0.7, hide_dec_labels=True, colour_bar_label=True)

fig.savefig('different_MWA_beam_plots.png',bbox_inches='tight', dpi=300)
plt.close()
