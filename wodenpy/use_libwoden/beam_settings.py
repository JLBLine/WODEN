...
#         num_primarybeam_values = chunk_map.n_points*num_freqs*num_times
...
#         num_primarybeam_values = chunk_map.n_gauss*num_freqs*num_times
...
#         num_primarybeam_values = chunk_map.n_shapes*num_freqs*num_times
