...
def read_radec_count_components(skymodel_path : str) -> Component_Type_Counter:
    ...
    if skymodel_path[-5:] == '.fits':
        ...
        sys.exit('The filename fed into `wodenpy/read_skymodel/read_radec_count_components` was not of a supported file type. Currently supported formats are: .fits, .yaml')
...
def read_skymodel_chunks(skymodel_path : str, chunked_skymodel_maps : list,
    ...
    if skymodel_path[-5:] == '.fits':
        ...
        sys.exit('The filename fed into `wodenpy/read_skymodel/read_skymodel_chunks` was not of a supported file type. Currently supported formats are: .fits, .yaml')
