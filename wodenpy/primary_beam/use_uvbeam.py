...
def run_uvbeam(uvbeam_objs: np.array,
    ...
    for time_ind, time in enumerate(times):
        ...
        for station_ind, beam_obj in enumerate(uvbeam_objs):
            ...
            all_output_jones[station_ind, time_ind, :, :, 0, 0] = response[1,1,:,:]
            all_output_jones[station_ind, time_ind, :, :, 0, 1] = response[0,1,:,:]
            all_output_jones[station_ind, time_ind, :, :, 1, 0] = response[1,0,:,:]
            all_output_jones[station_ind, time_ind, :, :, 1, 1] = response[0,0,:,:]
